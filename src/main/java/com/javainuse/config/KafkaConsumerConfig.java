...
public class KafkaConsumerConfig 
{
    ...
    public ConsumerFactory<String, EmployeeDto> userConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EmployeeDto> userKafkaListenerContainerFactory() {
